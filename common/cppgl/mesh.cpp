...
Mesh::Mesh(const std::string& name, std::string animation_name, const aiMesh *mesh_ai) : Mesh(name) {
...
void Mesh::load_animation(const aiScene *scene_ai, std::string animation_name, bool first, bool default_attack) {

}

void Mesh::do_animation(std::string anim_id) {
