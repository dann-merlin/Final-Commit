...
namespace ImGui
{
	...
	IMGUI_API bool			ShrinkingButton(const char* label, const ImVec2& size_arg);
	...
	IMGUI_API float			GetBestCalcTextSize(const char* text, float wished_width, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f);
